...
const ProductList = () => {
  ...
  const setLowerCost = useCartStore((state) => state.setLowerCost);

  const [products, setProducts] = useState(initialProducts);

  const handleLowerCost = () => {
  ...
  return (
    <>
      <ButtonContainer>
        <LowerButton onClick={handleLowerCost}>낮은 가격순</LowerButton>
      </ButtonContainer>
